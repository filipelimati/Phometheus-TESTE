                          ...
                          <div class="row">
                            <form role="form">                                                                    
                                ...
                                <div class="form-group col-sm-3">
                                    <label>CPF</label>
                                    <input name="cpf" type="text" class="form-control" placeholder="Digite o CPF" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" onkeydown="javascript: fMasc( this, mCPF );" maxlength="14" required autofocus>
                                </div>
